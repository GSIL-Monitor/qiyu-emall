...
public class ResponseData implements Serializable {
    ...
    public static ResponseData failure(BusinessException e) {
        return new ResponseData(new Meta(e.getCode(), e.getMessage()), null);
    }
     ...
     * @return ResponseData
     */
    public static ResponseData failure(ConstantEnum constantEnum) {
    	return new ResponseData(new Meta(constantEnum.getCodeStr(), constantEnum.getValueStr()), null);
    }
    ...
    public static ResponseData failureResult(String errno,String msg, Object data, Integer currentPage, Integer pageSize, Integer totalCount) {
        return new ResponseData(new Meta(errno, msg), new Result(data, new Page(currentPage, pageSize, totalCount)));
    }
